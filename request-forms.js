...
export class RequestForms extends LitElement {
    // return a promise for contract changes.
    static getMetaConfig() {
        return {
            controlName: 'RequestForms',
...
function populateAttachmentJson() {
  var json = {};
  json['fileEn'] = retrieveAttachments('.fileEn');
  json['fileEs'] = retrieveAttachments('.fileEs');
  json['fileFr'] = retrieveAttachments('.fileFr');
  json['filePt'] = retrieveAttachments('.filePt');
  document.querySelector('.templateMarkup textarea').value = JSON.stringify(json);
}
...
const elementName = 'request-forms';
customElements.define(elementName, RequestForms);